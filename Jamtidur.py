...
while True:
    try:
        ...
        if 1 <= jam_tidur and 3 >= jam_tidur:
            ...
            print("mantapp,pola tidur kamu sudah bagus")
            ...
            print("pola tidur kamu lumayan baguslah")
            print("jam tidur mu lumayan baik : \n\nmanfaat : \n1.pemulihan extra.\n2.peningkatan kreativitas.\n3.fokus yang tajam.\n\ndampak buruk : \n1.kepala sakit.\n2.kesulitan bangun.\n3.resiko penyakit tertentu.")
        else:
            print("kamu tidur nya berlebihan ")
            break
        while True:
            isdone = str(input("apakah masih mau lagi (mau/tidak) ? ="))
            if isdone == "mau":
                    break
            elif isdone == "tidak":
                    print("TERIMA KASIH SAYANGG")
            else:
                    print("masukan mau/tidak saja")
            break
    except ValueError:
